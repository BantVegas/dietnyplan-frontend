...
export default function SelectAgeWoman() {
  ...
  // SEO nastavenie pre túto podstránku (title a description)
  useEffect(() => {
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-tr from-teal-100 via-white to-teal-200">
      ...
      <main className="flex-1 flex flex-col items-center pt-28 px-2">
        ...
        <p className="max-w-xl text-center text-gray-700 text-base sm:text-lg mb-8">
          Každá životná etapa ženy má svoje špecifiká – od metabolizmu, hormonálnych zmien až po životné tempo.<br />
          Výber správneho veku nám umožní prispôsobiť <b>diétny plán presne tvojim potrebám</b>, nech už si vo fáze kariéry, materstva alebo menopauzy.<br />
